    ...
    <div class="nsofts-container">
        ...
        <div class="row g-4">
            ...
            <div class="col-xxl-3 col-md-6">
                 <a href="manage_data_deletion.php" style="text-decoration: none; color: inherit;">
           ...
           <div class="col-xxl-3 col-md-6">
    <a href="manage_dns.php" style="text-decoration: none; color: inherit;">
        <div class="card card-raised border-start border-info border-4">
            ...
            <div class="col-xxl-3 col-md-6">
                <a href="manage_report.php" style="text-decoration: none; color: inherit;">
            ...
            <div class="col-xxl-3 col-md-6">
                <a href="manage_ads.php" style="text-decoration: none; color: inherit;">
        ...
        <div class="col-lg-7 col-md-6">
            <a href="settings_app_ui.php" style="text-decoration: none; color: inherit;">

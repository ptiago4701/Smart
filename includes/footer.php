    ...
    <footer id="nsofts_footer">
        <div class="nsofts-container d-sm-flex justify-content-between text-center">
            <span>Copyright &copy; <?php echo date('Y'); ?> <a target="_blank" href=""><span class="fw-semibold">Corei7Minus</a> All rights reserved.</span></span>
            <div class="d-flex justify-content-center mt-2 mt-sm-0">
                ...
                <a href="https://t.me/corei7minus" class="me-3" target="_blank">Telegram</a>
            </div>
        </div>
    </footer>
    <!-- End: footer -->

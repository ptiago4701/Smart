<?php $page_title="Settings Extream codes";
    ...
    if(isset($_POST['app_submit'])){
        ...
        $data = array(
            ...
            'is_xui_vodextra'  => ($_POST['is_xui_vodextra']) ? 'true' : 'false', // New setting
        'is_xui_vod3rparty'  => ($_POST['is_xui_vod3rparty']) ? 'true' : 'false' 
        );
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="nsofts_setting_content_1" role="tabpanel" aria-labelledby="nsofts_setting_1" tabindex="0">
                                <form action="" name="settings_app" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 row">
                                        <label for="" class="col-sm-2 col-form-label">Active Vod External App(install separate app)</label>
                                        <div class="col-sm-10">
                                            <div class="nsofts-switch d-flex align-items-center">
                                                <input type="checkbox" id="is_xui_vodextra" name="is_xui_vodextra" value="true" class="cbx hidden" <?php if($settings_data['is_xui_vodextra']=='true'){ echo 'checked'; }?>/>
                                                <label for="is_xui_vodextra" class="nsofts-switch__label"></label>
                                            </div>
                                        </div>
                                    </div>
                                    
                                    <div class="mb-3 row">
                                        <label for="" class="col-sm-2 col-form-label">Active 3rd Party Vod</label>
                                        <div class="col-sm-10">
                                            <div class="nsofts-switch d-flex align-items-center">
                                                <input type="checkbox" id="is_xui_vod3rparty" name="is_xui_vod3rparty" value="true" class="cbx hidden" <?php if($settings_data['is_xui_vod3rparty']=='true'){ echo 'checked'; }?>/>
                                                <label for="is_xui_vod3rparty" class="nsofts-switch__label"></label>
                                            </div>
                                        </div>
                                    </div>
